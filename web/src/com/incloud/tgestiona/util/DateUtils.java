...
//    }
	...
	/*
	 * public static Date getCurrentDate() { ZonedDateTime currentZonedDateTime =
	 * getDefaultCurrentZonedDateTime(); Optional<Date> currentDateOptional =
	 * zonedDateTimeToDateTime(currentZonedDateTime); Date fechaProceso =
	 * currentDateOptional.orElseThrow(() -> new
	 * ServiceException("no se pudo obtener fecha del proceso")); return
	 * fechaProceso; }
	 */
	...
	public static Date stringToUtilDate(String stringDate) {
		...
		return new Date(java.sql.Date
				.valueOf(LocalDate.parse(stringDate, DateTimeFormatter.ofPattern(DEFAULT_DATE_FORMAT))).getTime());
	}
