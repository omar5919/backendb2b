...
public class OfertasDetalle extends BaseDomain implements Identifiable<Integer>, Serializable {
	...
	/**
	 * Set the {@link #spAccionIsis} without adding this OfertasDetalle instance on
	 * the passed {@link #spAccionIsis}
	 */
	...
	/**
	 * Set the {@link #spCondicionCircuito} without adding this OfertasDetalle
	 * instance on the passed {@link #spCondicionCircuito}
	 */
	...
	/**
	 * Set the {@link #ssCondicionSisego} without adding this OfertasDetalle
	 * instance on the passed {@link #ssCondicionSisego}
	 */
	...
	/**
	 * Set the {@link #spTipoSede} without adding this OfertasDetalle instance on
	 * the passed {@link #spTipoSede}
	 */
	...
	/**
	 * Set the {@link #spMedioAcceso} without adding this OfertasDetalle instance on
	 * the passed {@link #spMedioAcceso}
	 */
	...
	/**
	 * Set the {@link #spTipoCircuito} without adding this OfertasDetalle instance
	 * on the passed {@link #spTipoCircuito}
	 */
	...
	// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	// many-to-one: OfertasDetalle.spTipoInstalacionSatelital ==>
	// TipoInstalacionSatelital.id
	// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	...
	/**
	 * Set the {@link #spTipoInstalacionSatelital} without adding this
	 * OfertasDetalle instance on the passed {@link #spTipoInstalacionSatelital}
	 */
