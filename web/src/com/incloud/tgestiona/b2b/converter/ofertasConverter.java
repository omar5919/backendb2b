    ...
    public static BaseBandejaResponse<List<ofertaDto>> convertToOfertaDTO(List<Ofertas> oList,Long total) {
        ...
        List<ofertaDto> ol = oList.stream().map(s ->
                ofertaDto.builder()
                        ...
                        .preventa(s.getPreventa() != null ? s.getPreventa().getNombre() : "")
                        .analistafinanciero(s.getAnalistafinanciero() != null ? s.getAnalistafinanciero().getNombre() : "")
                        .version(s.getVersion())
                        .fase(s.getOportunidad() != null ? s.getOportunidad().getFase() : "")
                        .oportunidad(s.getOportunidad() != null ? s.getOportunidad().getOportunidadcodigo() : "")
                        .cliente(s.getCliente().getDescripcion())
                        .descripcion(s.getDescripcion())
                        .estado(s.getEstado().getDescripcion())
                        .tipoproyecto(s.getTipoproyecto() != null ? s.getTipoproyecto().getDescripcion() : "")
