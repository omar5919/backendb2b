    ...
    public List<Integer> guardarservicios(@RequestBody List<OfertaDetalleDto> servicios) {
        ...
        for (OfertaDetalleDto e: servicios) {
            res.add(odRepo.guardarServicio(
                    ...
                    e.getRouter(),
                    e.getDte_actual(),
                    e.getRecurso_transporte_actual(),
                    e.getTipo_antena_actual(),
                    e.getSegmento_satelital_actual(),
                    e.getPozo_tierra_actual(),
                    e.getUps_actual(),
                    e.getVrf_actual(),
                    e.getOtros(),
                    e.getFacturacion(),
                    ...
                    e.getSva(),
                    e.getSvadescripcion(),
                    e.getFecha_llegada_propuesto(),
                    e.getComponentes_propuesto(),
                    e.getVrf_propuesto(),
                    e.getDetalle_accion_propuesto(),
                    e.getBw_propuesto(),
                    e.getLdn_propuesto(),
                    e.getVoz_propuesto(),
